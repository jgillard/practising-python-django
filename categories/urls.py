...
urlpatterns = [
    ...
    path('monzo-transactions/',
         views_experimental.MonzoTransactionsView.as_view(), name='monzo_transactions'),
    path('monzo-transactions/<int:days>/',
         views_experimental.MonzoTransactionsView.as_view(), name='monzo_transactions'),
    path('cash-transactions/',
         views_experimental.CashTransactionsView.as_view(), name='cash_transactions'),
    path('cash-transactions/<int:days>/',
         views_experimental.CashTransactionsView.as_view(), name='cash_transactions'),
    path('analysis/',
         views_experimental.AnalysisView.as_view(), name='analysis_view'),
    path('analysis/<int:days>/',
         views_experimental.AnalysisView.as_view(), name='analysis_view'),
    path('ingest/',
